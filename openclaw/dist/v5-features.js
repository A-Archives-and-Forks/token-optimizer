...
exports.V5_FEATURES = {
    ...
    verbosity_steer: {
        ...
        description: "Inject a tiered conciseness nudge on UserPromptSubmit when context is under pressure (25%+ fill, or 75%+ fill). Includes cooldown and critical-fill suppression.",
        defaultEnabled: false,
        risk: "medium",
