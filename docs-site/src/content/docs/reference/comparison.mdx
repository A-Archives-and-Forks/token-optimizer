...
| Source readable | 🟢 PolyForm Noncommercial, full source | 🟢 Public repository | 🟢 Apache-2.0 repository | 🔴 All Rights Reserved; reverse engineering prohibited by the Beta Agreement | 🟢 ELv2 source-available repository | N/A |
